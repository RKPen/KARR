		...
		<div id="main">
			...
			<div class="inner">
				...
				<header id="inner">
					...
					<p>"Unlock the Road to Savings: Discover premium car rentals at unbeatable prices, tailored to fit
				...
				<p class="text-center"><a href="fleet.php">View Fleet &nbsp;<i class="fa fa-long-arrow-right"></i></a>
				</p>
				...
				<div class="row">
					<div class="col-sm-6 text-center">
						<p class="m-n"><em>"Renting from KARR was a breeze from start to finish. The car we received was
								...
								our entire journey. Highly recommended for peace of mind!"</em>
						</p>
					...
					<div class="col-sm-6 text-center">
						<p class="m-n"><em>"I was incredibly impressed with the customer service at KARR. When I
								...
								customer satisfaction. They've earned a loyal customer in me!"</em>
						</p>
